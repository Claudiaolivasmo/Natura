...
export async function handler(event, context) {
  try {
    ...
    const logoPath = safeJoin(BRANDING_DIR, 'natura_realestate_color_footer_600x200.png');
      ...
      .composite([
        {
          ...
          // left, top -> se usan solo si quieres posición exacta
          gravity: 'center',   // 👈 fuerza el centrado
          blend: 'over',
          opacity: 0.85
        },
      ])
